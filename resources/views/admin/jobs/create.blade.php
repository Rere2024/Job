      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('jobs.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="job title" name="title" class="form-control py-2" value="{{old('title')}}" />
              @error('title')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea name="job_nature" id="" cols="30" rows="5" class="form-control py-2" >{{old('job_nature')}}</textarea>
              @error('job_nature')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number"  placeholder="Enter salary from" name="salary_from" class="form-control py-2" value="{{old('salary_from')}}"/>
              @error('salary_from')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number"  placeholder="Enter salary to" name="salary_to" class="form-control py-2" value="{{old('salary_to')}}"/>
              @error('salary_to')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            <label for=""
                class="form-label col-md-2 fw-bold text-md-end">Date line:</label>
            <div class="col-md-10">
